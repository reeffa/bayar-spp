...
$input = mysqli_query($conn, "INSERT INTO siswa (nis,nama,id_kelas) VALUES('$nis','$nama','$id_kelas')");
...
</div><a href="siswa.php" class="btn btn-link mb-1">Lihat data siswa lainnya</a>
</div></div>
