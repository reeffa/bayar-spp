...
<div class="col-18">
<form class="form-inline mt-5 mx-auto justify-content-center" action="kelas.php" method="post">
...
<a href="tbkelas.php" button type="submit" class="btn btn-dark py-3 px-4">tambah data</a>

<a href="kelas.php" class="btn btn-link">tampilkan semua</a>
...
$opsi=$_POST["pilih"];
$nama=$_POST["textcari"];
$input=mysqli_query($conn, "SELECT * from kelas WHERE $opsi like '%$nama%'");
}else{
$input=mysqli_query($conn, "SELECT * from kelas");
}
...
<td>
<a href='updkelas.php?id_kelas=$row[id_kelas]'>
<input type='button' class='btn btn-secondary py-3 px-4'
value='update'></a>

<a href='hpskelas.php?id_kelas=$row[id_kelas]'>
