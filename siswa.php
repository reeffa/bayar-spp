...
<div class="col-18">
<form class="form-inline mt-5 mx-auto justify-content-center" action="siswa.php" method="post">
...
<a href="tbsiswa.php" button type="submit" class="btn btn-dark py-3 px-4">tambah data</a>
<a href="siswa.php" class="btn btn-link">tampilkan semua</a>
...
$opsi=$_POST["pilih"];
$nama=$_POST["textcari"];
$input=mysqli_query($conn, "SELECT * from siswa WHERE $opsi like '%$nama%'");
}else{
$input=mysqli_query($conn, "SELECT * from siswa");
}
...
<td>
<a href='updsiswa.php?nis=$row[nis]'>
<input type='button' class='btn btn-secondary py-3 px-4'
value='update'></a>

<a href='hpssiswa.php?nis=$row[nis]'>
