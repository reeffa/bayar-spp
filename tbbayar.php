    ...
    <section class="ftco-section contact-section ftco-no-pb" id="contact-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">tambah bayar</h2>
            <p>tambah data pembayaran disini !!</p>
          </div>
...
$input = mysqli_query($conn, "INSERT INTO pembayaran(id_pembayaran,id_petugas,nis,tgl_bayar,jumlah_bayar) VALUES('$id_pembayaran','$id_petugas','$nis','$tgl_bayar','$jumlah_bayar')");
...
<input type="number" name="id_pembayaran" class="form-control">
</div>
...
</div><a href="bayar.php" class="btn btn-link mb-1">Lihat data pembayaran lainnya</a>
</div></div>
