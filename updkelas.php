...
$input = mysqli_query($conn, "UPDATE kelas SET nama_kelas='$nama_kelas', kompetensi_keahlian='$kompetensi_keahlian' WHERE id_kelas='$id_kelas'");
...
<h1 class="big big-2">bayar spp</h1>
            <h2 class="mb-4">update kelas</h2>
            <p>update data kelas disini !!</p>
</div>
</div>
